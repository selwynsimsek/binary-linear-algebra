...
(defun reduced-row-echelon-form (a)
  ...
  (bind (((m n) (array-dimensions a))
         ...
         (y1 (trtri u1))
         (y1 (bmm* y1 x1))
         (rm (bmm* (bt (stack-horizontally (bim r) (bt (bmm* (ibm u1) u2)))) (bt q)))
...
(defun reduced-row-echelon-form (a)
  ...
  (bind (((m n) (array-dimensions a))
         ...
         ;(y (bmm* (block-matrix (bmm* (trtri u1) (ltrtri l1)) nil u2 (bim (- n r))) (bt p)))
         )
    ;(print q)
...
(defun reduced-row-echelon-form (a)
  (bind (((:values x e) (row-echelon-form a))
         (r (array-dimension e 0)))
    (with-block-decomposition x1 _ _ _
        (x r)
